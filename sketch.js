...
function setup() {
	...
	mango2=new Mango(830,230,75);
	mango3=new Mango(700,250,77);
	mango4=new Mango(870,140,65);
	mango5=new Mango(780,180,85);
	mango6=new Mango(900,230,62);
	mango7=new Mango(1000,170,59);
	mango8=new Mango(970,250,45);
	mango9=new Mango(1050,250,58);
